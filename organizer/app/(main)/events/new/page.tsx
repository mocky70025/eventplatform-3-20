                                ...
                                <div className="space-y-2">
                                    {[
                                        ...
                                        <label key={v} className={cn("flex items-start gap-3 p-3 rounded-xl border cursor-pointer transition-colors", formData.exhibitorListVisibility === v ? "border-orange-400 bg-orange-50" : "border-slate-200 hover:border-slate-300")}>
                                            <input type="radio" name="exhibitorListVisibility" value={v} checked={formData.exhibitorListVisibility === v} onChange={handleChange} className="peer sr-only" />
                                            <span className="mt-1 relative w-[18px] h-[18px] rounded-full border-2 border-slate-300 peer-checked:border-orange-500 shrink-0 transition-colors after:content-[''] after:absolute after:inset-[3px] after:rounded-full after:bg-orange-500 after:opacity-0 peer-checked:after:opacity-100 after:transition-opacity" />
                                            <div>
