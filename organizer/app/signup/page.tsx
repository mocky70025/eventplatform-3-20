            ...
            <div className="relative z-10 w-full max-w-[480px] mx-4 bg-white rounded-3xl shadow-[0_4px_6px_rgba(0,0,0,0.02),0_12px_40px_rgba(0,0,0,0.06)] px-6 sm:px-11 py-10 sm:py-12">
                {isEmailSent ? (
                    ...
                    <>
                        ...
                        <p className="text-center text-sm text-slate-500 mb-7">主催者として無料で登録</p>
                        ...
                        <form onSubmit={handleSignup} className="space-y-4 mb-3">
                            ...
                            <button
                                type="submit"
                                disabled={isLoading}
                                className="w-full h-12 rounded-xl bg-orange-500 hover:bg-orange-600 text-white font-semibold text-sm shadow-lg shadow-orange-500/25 transition mt-2 disabled:opacity-50 flex items-center justify-center gap-2"
                            >
                                {isLoading ? (
                                    <>
