...
export default function OnboardingPage() {
    ...
    return (
        <div className="min-h-screen relative overflow-hidden flex items-center justify-center py-12 bg-gradient-to-br from-[#fdf8f1] via-orange-50 to-amber-100/40">
