    ...
    if (reviews.length === 0) {
        return (
            <div className="bg-white rounded-2xl border border-slate-200 p-6">
                ...
                <p className="text-sm text-slate-500 mb-6">イベント終了後に主催者から届いた評価です（直近3件）</p>
                <div className="text-center py-8">
                    <div className="w-12 h-12 bg-slate-100 rounded-xl flex items-center justify-center mx-auto mb-3">
                        <Star className="w-6 h-6 text-slate-300" />
                    </div>
                    <p className="text-sm text-slate-500">まだ評価がありません</p>
                    <p className="text-xs text-slate-500 mt-1">イベント終了後に主催者から評価が届きます</p>
                </div>
            </div>
        );
    }
                    ...
                    <div key={review.id} className="py-5 first:pt-0 last:pb-0">
                        <div className="flex items-start justify-between mb-2">
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 bg-store-100 rounded-full flex items-center justify-center text-sm font-bold text-store-700">
