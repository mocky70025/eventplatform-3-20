  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f0fdf4] px-4">
      ...
      <div className="relative z-10 w-full max-w-[440px] bg-white rounded-3xl shadow-[0_4px_6px_rgba(0,0,0,0.02),0_12px_40px_rgba(0,0,0,0.06)] px-6 sm:px-11 py-10 sm:py-12">
        ...
        <h2 className="text-center text-[22px] font-bold text-slate-900 mb-1.5">新規登録</h2>
        <p className="text-center text-sm text-slate-500 mb-7">出店者アカウントを作成します</p>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                minLength={8}
                className="w-full rounded-xl border border-slate-300 px-4 py-2.5 pr-11 text-sm focus:outline-none focus:ring-2 focus:ring-store-500 focus:border-store-500 transition placeholder:text-slate-500"
              />
              <button
                type="button"
