                        ...
                        <div>
                            ...
                            <div className="flex gap-2">
                                ...
                                <button
                                    ...
                                    className="inline-flex items-center gap-1.5 px-4 py-2.5 rounded-xl text-sm font-medium bg-store-500 text-white hover:bg-store-600 disabled:opacity-50 transition-colors"
                                >
