        ...
        <div className="space-y-10 text-slate-700 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-slate-600">
              ...
              <li>
                <span className="font-medium text-slate-700">出店者プロフィール情報:</span> 店舗名、業態、ジャンル、住所、紹介文、プロフィール写真
              </li>
              <li>
              ...
              <li>
                <span className="font-medium text-slate-700">出店申込情報:</span> 申込内容、提出書類、コミュニケーション履歴
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-slate-600">
              <li>
                <span className="font-medium text-slate-700">イベント主催者への提供:</span> 出店申込を行った場合、申込に必要な情報（店舗名、業態、連絡先等）をイベント主催者に提供します
              </li>
              <li>
