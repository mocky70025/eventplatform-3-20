    ...
    <tr><td align="center">
      <table width="480" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:16px;padding:40px;box-shadow:0 2px 8px rgba(0,0,0,0.06)">
        ...
        <tr><td align="center" style="padding-bottom:28px">
          <a href="${confirmUrl}" style="display:inline-block;background:#10b981;color:#fff;font-size:15px;font-weight:bold;text-decoration:none;padding:14px 32px;border-radius:10px">
            メールアドレスを確認する
          </a>
        </td></tr>
