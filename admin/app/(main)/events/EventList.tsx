            ...
            >
                <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                        <button className="text-slate-500 hover:text-slate-600 transition-colors flex-shrink-0">
                            ...
                            <div className="grid grid-cols-[280px_1fr] gap-8">
                                <div className="space-y-3">
                                    {event.main_image_url ? (
                                        <div>
                                            <p className="text-xs font-bold text-slate-500 uppercase tracking-wider mb-1.5">メイン画像</p>
                                    ...
                                    {event.venue_layout_url && (
                                        <div>
                                            <p className="text-xs font-bold text-slate-500 uppercase tracking-wider mb-1.5">会場レイアウト</p>
                                            <div className="relative aspect-video rounded-xl overflow-hidden border border-slate-200 bg-white">
                                        ...
                                        <div className="bg-white rounded-xl p-4 border border-slate-100">
                                            ...
                                            {(event.organizer_name || event.organizer_email || event.organizer_phone) && (
                                                <div className="mt-3 pt-3 border-t border-slate-100">
                                                    <p className="text-xs font-bold text-slate-500 uppercase tracking-wider mb-1">イベント担当者</p>
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        {event.terms_compliance && (
                                            <div className="bg-white rounded-xl p-4 border border-slate-100">
                                                <p className="text-xs font-bold text-slate-500 uppercase tracking-wider mb-1">規約の履行</p>
                                        ...
                                        {event.booth_qualification && (
                                            <div className="bg-white rounded-xl p-4 border border-slate-100">
                                                <p className="text-xs font-bold text-slate-500 uppercase tracking-wider mb-1">出店資格</p>
                                                <p className="text-sm text-slate-600 whitespace-pre-wrap max-h-28 overflow-y-auto">{event.booth_qualification}</p>
                                            </div>
                                        )}
                                        {event.cancel_policy && (
                                            <div className="bg-white rounded-xl p-4 border border-slate-100">
                                                <p className="text-xs font-bold text-slate-500 uppercase tracking-wider mb-1">キャンセルポリシー</p>
                                        ...
                                        {event.privacy_policy && (
                                            <div className="bg-white rounded-xl p-4 border border-slate-100">
                                                <p className="text-xs font-bold text-slate-500 uppercase tracking-wider mb-1">プライバシーポリシー</p>
            ...
            <div className="flex gap-1 bg-white border border-slate-200 rounded-xl p-1 w-fit">
                {STATUS_TABS.map(tab => (
                    ...
                    >
                        {tab.label}
                        {counts[tab.key] > 0 && (
                            <span className={`text-xs font-bold px-1.5 py-0.5 rounded-full ${activeFilter === tab.key
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="bg-slate-50/50 border-b border-slate-50">
                                    <th className="px-6 py-3 text-xs font-bold text-slate-500 uppercase tracking-wider">イベント名 / 主催者</th>
                                    <th className="px-6 py-3 text-xs font-bold text-slate-500 uppercase tracking-wider">日程 / 場所</th>
