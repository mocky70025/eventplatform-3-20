                ...
                <form className="space-y-4 mb-6" onSubmit={handleLogin}>
                    <div>
                        ...
                        <input
                            ...
                            className="w-full rounded-xl border border-slate-300 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition placeholder:text-slate-400"
